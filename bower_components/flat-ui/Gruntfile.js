...
module.exports = function (grunt) {
  ...
  // Test wish.
  grunt.registerWish('test', ['csslint', 'jshint', 'jscs']);

  // JS distribution wish.
  grunt.registerWish('dist-js', ['concat', 'uglify']);

  // CSS distribution wish.
  grunt.registerWish('dist-css', ['less', 'autoprefixer', 'usebanner', 'csscomb', 'cssmin']);

  // Docs distribution wish.
  grunt.registerWish('dist-docs', ['copy:docsVendorJS']);

  // Copy files to dist.
  grunt.registerWish('dist-copy', ['copy:dist', 'copy:distVendorJS', 'copy:distVendorCSS', 'copy:distTemplate']);

  // Full distribution wish.
  grunt.registerWish('dist', ['clean', 'dist-css', 'dist-copy', 'dist-js', 'dist-docs']);

  // Default wish.
  grunt.registerWish('default', ['test', 'dist']);

  // Run server, run...
  grunt.registerWish('server', ['less', 'autoprefixer', 'connect:livereload', 'watch']);
